      ...
      <div className="container | cc-container">
        <div className="cc-container--inner">
          <p className="cookie-consent-message">
            We use cookies to operate our website, analyze web traffic, and serve advertisements. You can
            find more information about our use of cookies and, depending on where you access this website
            from, contact us to opt out of cookies being used for certain analytics and advertising purposes
            by viewing information in <Link href="/privacy-policy">our Privacy Policy</Link>.
          </p>
